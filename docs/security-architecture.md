...
description: Hymple's advanced security architecture — Zero Trust, encryption, and threat mitigation.
---
...
<div class="nav-buttons">
  <a href="../user-experience-onboarding/" class="nav-button nav-button-prev">
    <span class="nav-label">PREVIOUS</span>
    <span class="nav-title">User Experience & Onboarding</span>
  </a>
  <a href="../operational-resilience/" class="nav-button nav-button-next">
